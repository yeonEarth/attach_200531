...
public class Page1_ScheduleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //부모 액티비티와 연결
    Page1_ScheduleAdapter(ArrayList<Page1_Main.RecycleItem> list) {
        items = list;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case HEADER:
                ...
                Page1_ScheduleAdapter.HeaderViewHolder headerViewHolder = new Page1_ScheduleAdapter.HeaderViewHolder(view);
                return headerViewHolder;

            case CHILD:
                LayoutInflater inflater2 = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View view2 = inflater2.inflate(R.layout.page1_recyclerview_item,parent,false);
                Page1_ScheduleAdapter.ItemViewHolder itemViewHolder = new Page1_ScheduleAdapter.ItemViewHolder(view2);
            ...
            case CITY:
                ...
                Page1_ScheduleAdapter.CityViewHolder cityViewHolder = new Page1_ScheduleAdapter.CityViewHolder(view3);
